...
{
$mysqli->query("insert into wishlist(userId,productId) values('".$_SESSION['id']."','$pid')");
...
if(isset($_POST['submit']))
{
	...
	$review=$_POST['review'];
	$mysqli->query("insert into productreviews(productId,quality,price,value,name,summary,review) values('$pid','$qty','$price','$value','$name','$summary','$review')");
}
...
<?php
$ret=$mysqli->query("select category.categoryName as catname,subCategory.subcategory as subcatname,products.productName as pname from products join category on category.id=products.category join subcategory on subcategory.id=products.subCategory where products.id='$pid'");
while ($rw=$ret->fetch_array()) {
...
<!-- ==============================================LATEST PRODUCT============================================== -->
	...
	<div class="sidebar-widget-body m-t-10">
		<div class="accordion">
		            ...
		            <?php
$ret=$mysqli->query("select * from products order by id desc limit 4");
...
?>
			...
			<div class="image">
				...
				<img  src="admin/productimages/<?php echo htmlentities($row['productName']);?>/<?php echo htmlentities($row['productImage1']);?>" data-echo="admin/productimages/<?php echo htmlentities($row['productName']);?>/<?php echo htmlentities($row['productImage1']);?>"  width="100" height="70" style="border: 2px solid black" alt=""></a>
			</div>
				<h5 class="name"><a href="product-details.php?pid=<?php echo htmlentities($row['id']);?>"><?php echo htmlentities($row['productName']);?></a></h5>
				
					<h6 class="price">RM<?php echo htmlentities($row['productPrice']);?></h6>
...
<div class="sidebar-widget hot-deals wow fadeInUp">
	...
	<div >
								   ...
								   <?php
$ret=$mysqli->query("select * from products order by rand() limit 4 ");
while ($rws=$ret->fetch_array()) {
...
<?php 
$ret=$mysqli->query("select * from products where id='$pid'");
while($row=$ret->fetch_array())
{
...
<?php $rt=$mysqli->query("select * from productreviews where productId='$pid'");
$num=$rt->num_rows;
{
?>		
...
<div class="stock-container info-container m-t-10">
							...
							<div class="price-container info-container m-t-20">
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="price-box">
						<span class="price">RM <?php echo htmlentities($row['productPrice']);?></span><br />
						<span class="price-before-discount" style="color: red;">Price before discount = RM<?php echo htmlentities($row['productPriceBeforeDiscount']);?></span>
										</div>
									</div>
							...
							<div class="product-social-link m-t-20 text-right">
								...
								<div class="social-icons">
						            <ul class="list-inline">
						                <li> <a href="mailto:raspberypi0@gmail.com"><i class="icon fa fa-envelope"></i></a></li>
						                <li><a href="skype:mgt03_2?chat"><i class="icon fa fa-skype"></i></a></li>
						                <li><a href="https://wa.me/+60177553365"><i class="icon fa fa-whatsapp"></i></a></li>
						                <li><a href="tg://user?id=@Mirasyafikah""><i class="icon fa fa-telegram"></i></a></li>
						            </ul><!-- /.social-icons -->
						        </div>
							</div>
...
<?php $qry=$mysqli->query("select * from productreviews where productId='$pid'");
while($rvw=$qry->fetch_array())
{
?>
...
<section class="section featured-product wow fadeInUp">
	...
	<div class="owl-carousel home-owl-carousel upsell-product custom-carousel owl-theme outer-top-xs">
		...
		<?php 
$qry=$mysqli->query("select * from products where subCategory='$subcid' and category='$cid'");
while($rw=$qry->fetch_array())
{
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="product-details.php?pid=<?php echo htmlentities($rw['id']);?>"><img  src="assets/images/blank.gif" data-echo="admin/productimages/<?php echo htmlentities($rw['productName']);?>/<?php echo htmlentities($rw['productImage1']);?>" width="200" height="200" style="border: 2px solid black" alt=""></a>
			</div><!-- /.image -->			
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				<span class="price">RM<?php echo htmlentities($rw['productPrice']);?>			</span>
				<span class="price-before-discount">RM<?php echo htmlentities($rw['productPriceBeforeDiscount']);?></span>
