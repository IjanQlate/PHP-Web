...
header('location:login.php');
	...
	if (isset($_GET['id'])) {
		...
		$mysqli->query("delete from orders  where userId='".$_SESSION['id']."' and paymentMethod is null and id='".$_GET['id']."' ");
		;
