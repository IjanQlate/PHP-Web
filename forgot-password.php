...
$query=$mysqli->query("SELECT * FROM users WHERE email='$email' and contactno='$contact'");
$num=$query->fetch_array();
if($num>0)
{
$extra="forgot-password.php";
$mysqli->query("update users set password='$password' WHERE email='$email' and contactno='$contact' ");
