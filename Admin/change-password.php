...
if(isset($_POST['submit']))
{
	...
	$sql = "SELECT password FROM  admin where password='".md5($_POST['password'])."' AND username='".$_SESSION['alogin']."'";
	$result = mysqli_query($mysqli,$sql);
	$num = mysqli_num_rows($result);

	if($num>0)
	{
	 $con=$mysqli->query("update admin set password='".md5($_POST['newpassword'])."', updationDate='$currentTime' where username='".$_SESSION['alogin']."'");
