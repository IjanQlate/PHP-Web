...
//$ret=$mysqli->query("select productImage1 from products where id='$pid'");
...
//unlink($dir.'/'.$pimage);
	...
	$sql=$mysqli->query("update  products set productImage1='$productimage1' where id='$pid' ");
...
$query=$mysqli->query("select productName,productImage1 from products where id='$pid'");
$cnt=1;
