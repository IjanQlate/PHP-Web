...
$query=$mysqli->query("insert into ordertrackhistory(orderId,status,remark) values('$oid','$status','$remark')");
$sql=$mysqli->query("update orders set orderStatus='$status' where id='$oid'");
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <?php 
$ret = $mysqli->query("SELECT * FROM ordertrackhistory WHERE orderId='$oid'");
   ...
   <?php 
$st='Delivered';
   $rt = $mysqli->query("SELECT * FROM orders WHERE id='$oid'");
     while($num=$rt->fetch_array())
     {
