...
if(isset($_POST['submit']))
{
	...
	$subcat2id=$_POST['subcat2id'];
	$subcat3id=$_POST['subcat3id'];
...
$sql=$mysqli->query("insert into products(category,subCategory,subcat2id,subcat3id,productName,productCompany,productPrice,productDescription,shippingCharge,productAvailability,productImage1,productImage2,productImage3,productPriceBeforeDiscount) values('$category','$subCategory','$subcat2id','$subcat3id','$productname','$productcompany','$productprice','$productdescription','$productscharge','$productavailability','$productimage1','$productimage2','$productimage3','$productpricebd')");
...
<div class="controls">
<select name="subcat2id" class="span8 tip" onChange="getSubcat(this.value);"  >
...
<div class="controls">
<select name="subcat3id" class="span8 tip" onChange="getSubcat(this.value);"  >
<option value="">Select Sub Category 3</option> 
<?php $query=$mysqli->query("select * from subcat3");
while($row=$query->fetch_array())
{?>

<option value="<?php echo $row['id'];?>"><?php echo $row['subcat3'];?></option>
<?php } ?>
</select>
</div>
</div>
