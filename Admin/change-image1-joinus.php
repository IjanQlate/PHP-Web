...
$ret=$mysqli->query("select image1 from joinus where id='$lid'");
...
//unlink($dir.'/'.$pimage);
	...
	$sql=$mysqli->query("update  joinus set image1='$image1' where id='$lid' ");
...
$query=$mysqli->query("select assign,image1 from joinus where id='$lid'");
$cnt=1;
