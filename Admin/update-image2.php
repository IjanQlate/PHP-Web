...
//$ret=$mysqli->query("select productImage2 from products where id='$pid'");
...
//unlink($dir.'/'.$pimage);
	...
	$sql=$mysqli->query("update  products set productImage2='$productimage2' where id='$pid' ");
...
$query=$mysqli->query("select productName,productImage2 from products where id='$pid'");
$cnt=1;
