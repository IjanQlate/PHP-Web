...
if(isset($_POST['submit']))
{
	...
	$query=$mysqli->query("select productName from products where id='pid'");
	$result=$query->fetch_row();
	$pname=$result['productName'];
	
rename("productimages/$pname","productimages/$productname");
$sql=$mysqli->query("update  products set category='$category',subCategory='$subcat',productName='$productname',productCompany='$productcompany',productPrice='$productprice',productDescription='$productdescription',shippingCharge='$productscharge',productAvailability='$productavailability',productPriceBeforeDiscount='$productpricebd' where id='$pid' ");
...
$query=$mysqli->query("select products.*,category.categoryName as catname,category.id as cid,subcategory.subcategory as subcatname,subcategory.id as subcatid from products 
