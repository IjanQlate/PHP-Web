...
if(isset($_POST['submit']))
{
	...
	$id=intval($_GET['id']);
$sql=$mysqli->query("update category set categoryName='$category',categoryDescription='$description',updationDate='$currentTime' where id='$id'");
...
<?php
$id=intval($_GET['id']);
$query=$mysqli->query("select * from category where id='$id'");
