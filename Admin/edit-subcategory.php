...
if(isset($_POST['submit']))
{
	...
	$id=intval($_GET['id']);
$sql=$mysqli->query("update subcategory set categoryid='$category',subcategory='$subcat',updationDate='$currentTime' where id='$id'");
...
<?php
$id=intval($_GET['id']);
$query=$mysqli->query("select category.id,category.categoryName,subcategory.subcategory from subcategory join category on category.id=subcategory.categoryid where subcategory.id='$id'");
