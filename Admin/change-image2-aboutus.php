...
$ret=$mysqli->query("select image2 from aboutus where id='$lid'");
//$dir="productimages";
//unlink($dir.'/'.$pimage);


	move_uploaded_file($_FILES["image2"]["tmp_name"],"img/$assign/".$_FILES["image2"]["name"]);
	$sql=$mysqli->query("update  aboutus set image2='$image2' where id='$lid' ");
...
<head>
	...
	<title>Admin| Update Second Image</title>
...
$query=$mysqli->query("select assign,image2 from aboutus where id='$lid'");
$cnt=1;
...
<div class="controls">
<input type="file" name="image2" id="productimage1" value="" class="span8 tip" required>
</div>
</div>
