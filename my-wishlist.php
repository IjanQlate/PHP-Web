...
if(isset($_GET['del']))
{
$query=$mysqli->query("delete from wishlist where id='$wid'");
}


if(isset($_GET['action']) && $_GET['action']=="add"){
	$id=intval($_GET['id']);
	$query=$mysqli->query("delete from wishlist where productId='$id'");
...
<div class="body-content outer-top-bd">
	...
	<div class="table-responsive">
		<table class="table">
			...
			<tbody>
<?php
$ret=$mysqli->query("select products.productName as pname,products.productImage1 as pimage,products.productPrice as pprice,wishlist.productId as pid,wishlist.id as wid from wishlist join products on products.id=wishlist.productId where wishlist.userId='".$_SESSION['id']."'");
$num=$ret->num_rows;
	if($num>0)
	{
...
?>
				...
				<?php } } else{ ?>
				<tr>
					<td style="font-size: 18px; ">Your Wishlist is Empty</td>
