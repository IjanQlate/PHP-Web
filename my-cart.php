...
if(!empty($_SESSION['cart'])){
		foreach($_POST['remove_code'] as $key){
			...
			echo "<script>alert('Your Product has been Removed from Cart');</script>";
...
$mysqli->query("insert into orders(userId,productId,quantity) values('".$_SESSION['id']."','$qty','$val34')");
		...
		<tbody>
				<tr>
					<td>
						...
						<?php $qry=$mysqli->query("select * from users where id='".$_SESSION['id']."'");
while ($rt=$qry->fetch_array()) {
...
<div class="col-md-4 col-sm-12 cart-shopping-total">
	...
	<?php } else {
	echo "<p> <font size=4px>Your shopping Cart is empty</font> </p>";
